...
HEROES="juggernaut:juggernaut axe:axe crystal_maiden:crystal_maiden sniper:sniper zeus:zuus phantom_assassin:phantom_assassin anti_mage:antimage lina:lina lich:lich drow_ranger:drow_ranger windranger:windrunner bristleback:bristlebog sven:sven storm_spirit:storm_spirit leshrac:leshrac faceless_void:faceless_void ursa:ursa lion:lion shadow_fiend:nevermore pugna:pugna invoker:invoker tidehunter:tidehunter mirana:mirana clinkz:clinkz"
mkdir -p "$OUT" "$DEST"
