  ...
  plugins: [
    ...
    VitePWA({
      ...
      injectManifest: {
        ...
        // какие экраны игрок успел открыть до самолёта. WebP (портреты, предметы, команды) —
        // ~1.4 МБ на 325 файлов; пиксельные PNG Аркады (иконки способностей и предметов, режим по
        // умолчанию) — ещё ~0.4 МБ на 594 файла. Без precache иконки пропадали офлайн после
