...
// CI — на эфемерном mock (gen:mock). Перебор: scripts/sweep_seeds_both.ts дважды (mock/real),
// берётся пересечение. Критерии: 3 этапа с карточной наградой + static-смерть ≤6 этапов
// (иначе тест «завершение забега» не влезает в бюджет slow()).
const CAMP_SEED = "camp-e2e-26";
...
const CHEAT_SEED = process.env.CHEAT_SEED ?? "cheat-e2e-15";
