...
// scripts/find_camp_seed_deep.ts повторяет путь теста «пассивные карточки» на три этапа.
const CAMP_SEED = "camp-e2e-1";
...
// Пере-подобран 2026-08-09 тем же сдвигом рынка: scripts/find_cheat_seed_deep.ts моделирует
// boostInCamp на весь первый акт; подтверждён живым прогоном :426/:535.
const CHEAT_SEED = process.env.CHEAT_SEED ?? "cheat-e2e-1";
