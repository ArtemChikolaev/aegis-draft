...
export function TournamentScreen() {
  ...
  // Плейтест 2026-08-09: у «Показать результат» камера НЕ целится в сетку плей-офф. Раньше здесь
  // был scrollTo(playoffsRef), и он стартовал в одном коммите со скроллом к итогам ниже
  // (playoffsDone в instant-режиме истинен сразу) — два smooth-скролла дрались, экран дёргался.
  // Единственная цель шортката — финальная таблица, к ней и едем (эффект playoffsDone).
