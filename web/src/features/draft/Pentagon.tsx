...
/** Сила связи цветом по общей tier-шкале (токены --chem-*). У 322-0 все связи одного цвета
 *  и различаются лишь толщиной — цвет сообщает силу нагляднее, это наше улучшение.
 *
 *  Пороги — ПЕРЦЕНТИЛИ реального распределения (замер 2026-07-17 по squadSynergy: 7282 пары
...
function chemTier(bonus: number): "strong" | "good" | "mid" | "weak" {
  ...
  if (bonus >= 0.4) return "mid";  // p83: ~92+
  return "weak";
}
