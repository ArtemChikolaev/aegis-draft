...
export const HERO_TINT: Record<string, string> = {
  ...
  lycan: "#b09a7a", lone_druid: "#8ad87a", alchemist: "#a0d84a", bane: "#7a5ad8", batrider: "#ff8a3a", bounty_hunter: "#e0c04a", broodmother: "#c85a5a", clockwerk: "#e0a04a",
  earth_spirit: "#8ad8a0", elder_titan: "#7ab0e0", ember_spirit: "#ff8a4a", grimstroke: "#8a6ad8", gyrocopter: "#e0b04a", keeper_of_the_light: "#ffe89a", magnus: "#8ab0c8", mars: "#d84a3a",
  ...
  phantom_lancer: "#6ab0d8", lifestealer: "#c8544a", enchantress: "#8ad86a", chen: "#e0d8a0", ancient_apparition: "#a0d8e8", monkey_king: "#e0a84a", dark_willow: "#a06ad8",
};
...
const ENEMY_SHEET: Record<string, string> = { centaur: "centaur_creep", corruption_totem: "ward_plague", satyr_defiler: "satyr", centaur_warden: "centaur_creep", troll_necromancer: "dark_troll", bone_idol: "ward_death", thunder_golem: "golem", river_warden: "slardar", dire_stalker: "night_stalker", standard_bearer: "dark_troll", shaman: "ogre_magi", archer: "clinkz", sporebearer: "venomancer" };
