...
const ENEMY_SHEET: Record<string, string> = { centaur: "centaur_creep", corruption_totem: "ward_plague", satyr_defiler: "satyr", centaur_warden: "centaur_creep", troll_necromancer: "dark_troll", bone_idol: "ward_death", thunder_golem: "golem", river_warden: "slardar", dire_stalker: "night_stalker", standard_bearer: "dark_troll", shaman: "ogre_magi", archer: "clinkz" };
