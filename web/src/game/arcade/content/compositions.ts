...
// (лечение/очищение), аванпост (обзор), разлом (T13.85: владелец 2026-09-13 «запустил Herald 2 — ни одного
// портала»; разлом на 5-й минуте — базовый бит акта, из композиций не вырезается) и не меньше двух
// чемпионов — иначе контракт не предложить.
...
export const COMPOSITIONS: Record<CompositionId, CompositionDef> = {
  ...
  /** Дикие угодья: лагерь, роща, курган, логово — маршрут через чемпионов, без торговли (кузни и каравана). */
  wilds: { id: "wilds", places: ["camp", "outpost", "pond", "grove", "barrow", "lair", "rift"], property: "tainted_pond" },
