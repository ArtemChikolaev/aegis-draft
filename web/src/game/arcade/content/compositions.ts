...
// (лечение/очищение), аванпост (обзор), разлом на 5-й и кузня на 12-й минуте (T13.85: владелец 2026-09-13
// «запустил Herald 2 — ни одного портала», «портала на 12 минуте не появилось» — расписание акта одно на все
// композиции, из них вырезаются только караван, курган и патрули) и не меньше двух чемпионов — иначе контракт
// не предложить.
...
export const COMPOSITIONS: Record<CompositionId, CompositionDef> = {
  ...
  /** Дикие угодья: лагерь, роща, курган, логово — маршрут через чемпионов, без каравана. */
  wilds: { id: "wilds", places: ["camp", "outpost", "pond", "grove", "barrow", "lair", "rift", "forge"], property: "tainted_pond" },
  ...
  /** Осада леса: лагерь, роща, логово, кузня — и патрули со знаменосцами между ними; без каравана и кургана. */
  siege: { id: "siege", places: ["camp", "outpost", "pond", "grove", "lair", "forge", "rift"], property: "siege" },
};
