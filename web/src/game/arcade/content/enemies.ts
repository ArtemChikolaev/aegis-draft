...
export const ENEMY_KINDS: Record<EnemyKindId, EnemyKind> = {
  kobold: { id: "kobold", hp: 14, speed: 78, dmg: 6, r: 10, xp: 1, gold: 1, fromMin: 0, weight: 10, tone: "grunt" },
  kobold_foreman: { id: "kobold_foreman", hp: 32, speed: 72, dmg: 9, r: 12, xp: 2, gold: 1, fromMin: 0.75, weight: 6, tone: "grunt" },
  hill_troll: { id: "hill_troll", hp: 44, speed: 96, dmg: 10, r: 11, xp: 3, gold: 2, fromMin: 1.5, weight: 6, tone: "swift" },
  ...
  roshan: { id: "roshan", hp: 7600, speed: 64, dmg: 46, r: 40, xp: 120, gold: 60, boss: true, fromMin: 99, weight: 0, tone: "boss" },
};
