...
- **Дольше живёт ≠ лучше играет.** Попытка добить Lina перезарядкой Dragon Slave 7 → 5.5 с и четвёртой зоной подняла не побед, а длительность: прогон вместо 1–2 с стал упираться в `MAX_TICKS` (30 прогонов считались 7 минут вместо 40 секунд), потому что герой выживает, но не успевает добить Древнего, а толпа копится. Правка откачена, расширение зоны оставлено. То же самое видно у Razor — его замер в свипе ушёл в таймаут. **Вывод для калибровки: резкий рост времени прогона — это не «стало сильнее», это патовый забег, и его надо считать регрессом.**
