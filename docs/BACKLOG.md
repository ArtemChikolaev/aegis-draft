...
- **T7.10 — Справочник и настройки: страницы вне забега + хардкор 🟨.** Начато 2026-07-18. Заход 1 из 3 (дальше — страница героев, затем паутина тиммейтов).
  ...
  - **Открытый вопрос (продуктовый, не технический):** справочник героев с выбором игрока — это тот же просмотр «на чём играет игрок», который закрывает хардкор, и сейчас он доступен во время хардкорного забега. Решать, прятать ли его там.
