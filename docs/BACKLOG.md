...
| Специализация актов и поздние цели | Dire-очищение/свет, River-переправы, поздняя подготовка; затем караван (кузня — T13.52, разлом — T13.58) | Акты отличаются решениями; события не требуют недоступного билду действия; финал и путь к нему всегда проходимы; у разлома определено поведение часов (сделано: часы акта стоят) | Плейтест целей карты и чемпионов; не начинать с четвёртого биома |
