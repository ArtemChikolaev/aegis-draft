...
- **Не сделано/наблюдения:** тайлы воды в терре статичны (базовая ширина) — расширение рисует рендер поверх; отлив не сушит базовое русло. Бот на River тайды не учитывает. Числа стартовые.
