...
- **План (остальные шаблонные герои):** Anti-Mage — Mana Break (удар сжигает «ману» врага: +урон по кастерам/элите и −скорость 1 с); Lich — Frost Shield (при <30% HP щит-аура с замедлением, кд 20 с); Windranger — Focus Fire (после каста 4 с атаки по ближайшей цели вдвое чаще); Leshrac — Pulse Nova (пока стоит на месте >1 с, пульсы урона вокруг); Lion — Finger stacks (убийство элиты навсегда +урон R); Pugna — Nether Ward (при касте ставит вард, бьющий врагов рядом); Invoker — Exort/Quas (чередование каста: следующий удар огонь/лёд); Tidehunter — Kraken Shell (каждые N урона сбрасывает замедление/стан и даёт броню); Mirana — Leap (рывок при получении урона, кд 12 с). Уникальные киты (Jugg, Axe, CM, Sniper, Zeus) уже фирменные. Балансный прогон `npm run sim:arcade` по героям — после второй волны.
