...
> Заведено из алгоритмического аудита 2026-07-12 ([audits/2026-07-12-322-0-scoring-algorithm.md](audits/2026-07-12-322-0-scoring-algorithm.md)). Оживляет Chemistry и углубляет Hero Synergy на реальных данных. Инженерный старт — по отдельной отмашке пользователя.
