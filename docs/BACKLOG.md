...
⬜ Дальше: несколько стейков разом / уровни, награда за сыгранный Stake сверх карьерной метки
(кандидаты — анлоки/косметика, НЕ +OVR), sim-агент с оптимизирующим драфтом героев — если
понадобится измерять supply-правила.
