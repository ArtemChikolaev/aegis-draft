...
- **Не сделано/наблюдения:** особенности не меняют поток Rng и китов — только базу; бот `sim:arcade` играет без них (флаг можно добавить при калибровке). Числа стартовые.
...
Запрос владельца — анализ и предложения по картам, косметике, мини-боссам, статусам и общей прокачке. Полный дизайн, ограничения референсов и приоритеты: [аудит контента и прогрессии](audits/2026-09-08-arcade-content-and-progression.md). Ниже направления для выбора следующего среза; числа в документе — прототипные. Существующие T13.27/T13.33/T13.36 по моделям и гардеробу не дублируются.
