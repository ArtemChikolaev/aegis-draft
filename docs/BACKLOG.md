...
### T13.80 — Косметика как в Dota: сборка облика по слотам и скины призывов/форм (владелец 2026-09-12) 🟨 срез 2 (2026-09-15) P2
...
- ⬜ Формы/призывы (Terrorblade, Lone Druid, волки Lycan после ремапа) и следующие герои — как в плане аудита; порог визуального качества композита по-прежнему принимается глазами (contact-лист `scratchpad/contact.mjs`-подход: клетки листов рядом), не по проценту.
