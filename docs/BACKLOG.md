...
- ⬜ Замер ботом (бот не выбирает цель — бьёт ближайшего; шаман сзади) и плейтест: если группа «непробиваема» для мили — shieldMult 0.3 → 0.5 или shieldSec 5 → 4. Дальше по §4: строй стрелков с объявленным залпом, спороносец.
