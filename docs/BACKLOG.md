...
- ⬜ Замер ботом (бот лужи не видит — его поле опасности их не учитывает; если спороносцы станут главной причиной смерти, добавить лужи в `botInput` как «опасность»); плейтест. На этом §4 отчёта закрыт: шаман, строй стрелков, спороносец.
