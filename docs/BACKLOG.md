...
- **Не сделано/наблюдения:** бот в караван не ходит; отметки мастерства нет (13 остаются). Если часы перемотаны, рядом может стоять и плановый торговец 3:00/6:00 — это не конфликт. Числа стартовые.
