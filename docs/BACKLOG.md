...
- **Замер кумулятивной лестницы** (300 общих сидов, база 31.3%): uncappedBoss 27.7 → +doubleBans
  ...
  комбинаций.
⬜ Дальше: sim-агент с оптимизирующим драфтом героев — если понадобится измерять supply-правила.
...
- ⬜ Дальше: пары зрителей/реванш той же комнатой; таймер хода; карьерная метка дуэлей;
  переиспользование relay в Arena MP2.
