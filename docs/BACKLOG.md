...
⬜ Дальше: пересмотр СЕМАНТИКИ doubleBans/uncappedBoss до состояния «работает и в сезоне»
(не числами), несколько стейков разом / уровни, награда за сыгранный Stake сверх карьерной метки.
