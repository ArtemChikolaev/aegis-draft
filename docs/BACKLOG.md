...
- ⬜ Дальше по аудиту §4: шаман поддержки со щитом группы, строй стрелков с объявленным залпом, спороносец — отдельными срезами после плейтеста осады; замер ботом композиции `siege` (n=48) — вместе с остальными.
