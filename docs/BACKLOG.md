...
#### R5.3 — Цена формы и карточка 🟨 (P1; trade-in и происхождение 2026-07-27, цена звёзд b1.45.0 2026-09-02; остался UI-хвост)
...
- ⬜ **Осталось:** полноценная карточка `до → после` по всем слагаемым с командой/годом.
- **Deps:** R5.2. Числа — `R10`.
