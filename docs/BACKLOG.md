...
- **T7.10 — Справочник и настройки: страницы вне забега + хардкор 🟨.** Начато 2026-07-18. Заход 1 из 3 (дальше — страница героев, затем паутина тиммейтов).
  ...
  - **Осталось по заходам:** страница героев (популярность), паутина тиммейтов (player-centric: игрок в центре, клик по соседу перецентровывает, фильтр окна). Примитив `ui/Select` сейчас без потребителей — переиспользуем под фильтры этих двух страниц.
