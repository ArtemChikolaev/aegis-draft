...
64 → 67, квалы 0.9 → 1.3/5, титулов/сезон 1.7 → 2.7, отбор финала 3 → 7%. Остаток: копилка cheap
всё ещё растёт ($6.6M) — единственный синк дешевле профицита; следующий кандидат, если захочется
дожать, — масштабируемая цена сбора или инфраструктура (большая фича, отдельное решение).
