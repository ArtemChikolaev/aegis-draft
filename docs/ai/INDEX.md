...
| [arcade-survivors-brief.md](../arcade-survivors-brief.md) | **Бриф по Death Must Die → Aegis Arcade** (2026-09-05): что такое референс, перевод механик на язык Dota (школы-предметы, Рошан/Aegis, ранги Herald–Immortal), осуществимость на нашем стеке, риски, вопросы владельцу. Смотри ПЕРЕД любым кодом режима Arcade (PRD §5.15, BACKLOG M13). |
