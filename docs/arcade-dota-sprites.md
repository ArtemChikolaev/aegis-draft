...
- **Герой выбегает из кадра / ряд каста пустой**: гашение root motion считается по НЕСУЩЕЙ кости (та, на которой
  больше всего веса вершин — таз/голова), относительно позы кадрирования, без порогов. Корень не годится (у Vengeful
