...
> **Осознанное расхождение Aegis Draft с v1.13.0 (playtest 2026-07-23):** эту часть референса не копируем. Сумма пары и содержащих её троек/четвёрок повторно учитывает одну связь и заранее забивает cap 13, поэтому приход реально сыгранного тиммейта может не менять Chemistry. В продукте считаются только уникальные пары; measured-формула выше сохранена как факт о 322-0, а не как текущая спецификация Aegis Draft.
